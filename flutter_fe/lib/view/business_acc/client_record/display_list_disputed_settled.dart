...
import 'package:flutter_fe/view/business_acc/client_record/client_disputed.dart';
import 'package:flutter_fe/view/business_acc/client_record/client_disputed_settled.dart';
import 'package:get_storage/get_storage.dart';
import 'package:google_fonts/google_fonts.dart';

class DisplayListRecordDisputedSettled extends StatefulWidget {
  const DisplayListRecordDisputedSettled({super.key});

  @override
  State<DisplayListRecordDisputedSettled> createState() =>
      _DisplayListRecordDisputedSettledState();
}

class _DisplayListRecordDisputedSettledState
    extends State<DisplayListRecordDisputedSettled> {
  ...
  Future<void> _fetchRequests() async {
    try {
      int userId = storage.read("user_id");
      final response =
          await _notificationController.getDisputedSettledRequests(userId);
                        ...
                        child: InkWell(
                          ...
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => ClientDisputedSettled(
                                  finishID: request["id"],
                                  role: role,
                                ),
                              ),
