...
class DisplayListRecordDisputed extends StatefulWidget {
  const DisplayListRecordDisputed({super.key});

  @override
  State<DisplayListRecordDisputed> createState() =>
      _DisplayListRecordDisputedState();
}

class _DisplayListRecordDisputedState extends State<DisplayListRecordDisputed> {
  ...
  Future<void> _fetchRequests() async {
    try {
      int userId = storage.read("user_id");
      final response =
          await _notificationController.getDisputedRequests(userId);
                        ...
                        child: InkWell(
                          ...
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => ClientDisputed(
                                  finishID: request["id"],
                                  role: role,
                                ),
                              ),
