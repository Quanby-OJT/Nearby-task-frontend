...
class ClientCancelled extends StatefulWidget {
  final int? requestID;
  final String? role;
  const ClientCancelled({super.key, this.requestID, this.role});

  @override
  State<ClientCancelled> createState() => _ClientCancelledState();
}

class _ClientCancelledState extends State<ClientCancelled> {
