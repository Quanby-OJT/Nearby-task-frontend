...
class _EscrowTokenScreenState extends State<EscrowTokenScreen> {
                    ...
                    child: Column(
                        ...
                        children: [
                              ...
                              return RichText(
                                text: TextSpan(
                                  ...
                                  children: <TextSpan>[
                                    ...
                                    TextSpan(
                                        text:
                                            ' IMONALICK Credit/s will be added to your account'),
                                  ],
                                ),
                              );
                            },
                          ...
                          if (selectedPaymentMethod == "GCash")
                            Text(
                                "You will be redirected to your GCash Application."),
                          if (selectedPaymentMethod == "PayMaya")
                            Text(
                                "You will be redirected to your PayMaya Application."),
                          SizedBox(height: 20),
                          Center(
                                  ...
                                  onPressed: () async {
                                    if (_formKey.currentState!.validate()) {
                                      ...
                                      Map<String, dynamic> response =
                                          await _escrowController
                                              .depositAmountToEscrow(
                                                  selectedPaymentMethod);
  ...
  Widget buildInputField(TextEditingController controller, Widget? suffixIcon,
      String label, String hint, ValueChanged<String>? onCardChanged) {
