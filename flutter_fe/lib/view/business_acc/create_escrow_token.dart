            ...
            children: [
              ...
              ValueListenableBuilder(
                ...
                builder: (context, value, child) {
                  return Text(
                    "You will receive: ${value.toStringAsFixed(0)} NearByTask Token/s to your account".replaceAllMapped(RegExp(r'\d{1,3}(?=(\d{3})+(?!\d))'), (Match m) => '${m[0]},'),
                    style: GoogleFonts.roboto(
                      fontSize: 16,
                    ),
                  );
              ...
              Center(
                child: ElevatedButton(
                  ...
                  style: ButtonStyle(
                    backgroundColor: WidgetStateProperty.all(Color(0XFF03045E)),
                  ),
                  child: Text(
                    "Deposit Amount",
                    style: GoogleFonts.roboto(
              ...
              Text(
                "NOTE: We will verify first your payment before receiving your tokens.",
                style: TextStyle(
  ...
  void warnUser(BuildContext parentContext){
    showDialog(
      ...
      builder: (BuildContext dialogContext){
        return AlertDialog(
          title: Text(
            "ALERT: Does the Amount You Entered Sufficient?",
            style: GoogleFonts.roboto(
              fontWeight: FontWeight.bold
            )
          ),
            ...
            TextButton(
              onPressed: () async{
                ...
                try {
                  ...
                  Map<String, dynamic> result = await _escrowController.depositAmountToEscrow();
