              ...
              child: Theme(
                data: Theme.of(context).copyWith(
                  colorScheme: ColorScheme.light(
                    primary:
                        Color(0xFFFF4081), // Pink color for completed portion
                    onSurface:
                        Colors.grey, // Gray color for uncompleted portion
                  ),
                ),
                child: Stepper(
                  ...
                  connectorColor: MaterialStateColor.resolveWith((states) {
                    return states.contains(MaterialState.selected)
                        ? Color(0xFFFF4081) // Pink for completed portion
                        : Colors.grey; // Gray for uncompleted portion
                  }),
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: stepState == StepState.complete
                            ? Color(0xFF0272B1) // Blue for completed steps
                            : Colors.grey, // Gray for uncompleted steps
                        border: Border.all(
                          color: Color(0xFF0272B1), // Blue border for all steps
                          width: 2,
                        ),
                      ),
                      child: Center(
