...
class TaskController {
  ...
  Future<TaskAssignment?> getAllAssignedTasks(BuildContext context, int userId) async {
    ...
    if (assignedTasks.containsKey('tasks')) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(assignedTasks['error'] ?? "Something Went Wrong while Retrieving Your Tasks."))
      );
    }
