...
export class ButtonComponent implements OnInit {
  ...
  impactClasses: Record<ButtonProps['tone'], Record<ButtonProps['impact'], string>> = {
    primary: {
      bold: 'bg-main-color text-primary-foreground hover:bg-main-color/90 focus-visible:ring-primary',
      light: 'bg-main-color/20 text-main-color hover:bg-main-color/30 focus-visible:ring-primary',
      none: 'bg-transparent text-main-color hover:bg-main-color/10 focus-visible:ring-primary',
    },
    danger: {
